...
var ranaly = require('ranaly').createClient(config.redis.port, config.redis.host, config.redis.key_prefix);
...
app.get('/', middleware.requireRole, middleware.generateMenu(config), function (req, res) {
...
app.get('/pages/:pageID', middleware.requireRole, middleware.generateMenu(config), function (req, res) {
 ...
 * API
 */
app.post('/api/amount_get/:buckets', middleware.requireRole, function (req, res) {
