...
apos.define('apostrophe-modal', {
    ...
    construct: function (self, options) {
        ...
        self.resizeContentHeight = function () {
            var headerHeight = self.$el.find('.apos-modal-header').outerHeight(), breadcrumbHeight = self.$el.find('.apos-modal-breadcrumb').outerHeight(), footerHeight = self.$el.find('.apos-modal-footer').outerHeight();
