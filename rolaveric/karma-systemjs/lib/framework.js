...
var initSystemjs = function (config) {
    ...
    var es6LoaderPath = pathOrNpm(kSystemjsConfig.config, basePath, 'es6-module-loader', 'es6-module-loader', '/dist/es6-module-loader.src.js');
    var systemjsPath = pathOrNpm(kSystemjsConfig.config, basePath, 'systemjs', 'systemjs', '/dist/system.src.js');
    var polyfillsPath = pathOrNpm(kSystemjsConfig.config, basePath, 'system-polyfills', 'systemjs', '/dist/system-polyfills.js');
    ...
    config.files.unshift(createIncludePattern(es6LoaderPath), createIncludePattern(polyfillsPath), createIncludePattern(systemjsPath));
    ...
    if (transpilerPath) {
        ...
        config.files.unshift(createIncludePattern(transpilerPath));
    }
    ...
    if (config.browsers && config.browsers.indexOf('PhantomJS') !== -1) {
        var phantomjsPolyfillPath = pathOrNpm(kSystemjsConfig.config, basePath, 'phantomjs-polyfill', 'phantomjs-polyfill', '/bind-polyfill.js');
        config.files.unshift(createIncludePattern(phantomjsPolyfillPath));
    }
