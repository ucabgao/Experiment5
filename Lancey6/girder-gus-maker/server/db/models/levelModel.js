...
var convert = require('../../imaging/convert');
var mapToCanvas = require('../../imaging/mapToCanvas');
var uploadMapThumb = require('../../imaging/upload');
var removeLocalMapThumb = require('../../imaging/delete');
// Calculate number of tiles for data validation
var TILE_MAP = require("../../../game/js/consts/tilemap");
var numTiles = Object.keys(TILE_MAP).length;
...
var map = {
    ...
    checksum: {
        ...
        default: function () {
            if (!this.objects)
                return '';
            return this.objects.reduce(function (prev, next) { return prev + next; }, '');
        }
    },
    objects: [{
            t: {
