...
router.get('/', getDocsAndSend('Playlist', ['title', 'creator', 'previewPic', 'totalLevels'], [{path: 'creator', select: 'name'},{path: 'levels', select: 'previewPic'}]));
...
router.delete('/:id', mustBeLoggedIn, getDocAndDeleteIfOwnerOrAdmin('Playlist'));
