...
Dolly.prototype.update = function () {
  ...
  } else if ( game.freeLookKey && game.toolsRemaining > 0 && game.freeLookKey.isDown ) {
  ...
  if ( this.targetAng !== null ) {
    ...
    this.rotation += ( this.targetAng - this.rotation ) * game.time.physicsElapsed * this.rotationFactor;
  }
