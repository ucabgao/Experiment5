...
under the License.
**/
var CollectionSchema: any; /* = require('./collection_schema'); */
...
interface to_json_documentShim {
	(o : Object): String;
}

interface docShim {
	key : String;
	to_json_document : to_json_documentShim;
}
...
Collection.prototype.insert_raw_json = function insert_raw_json(key : String, json_obj: undefined, callback) {
